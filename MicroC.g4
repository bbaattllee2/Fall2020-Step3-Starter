...
statement returns [StatementNode node] : base_stmt ';' {$node = $base_stmt.node;}
		  /* | if_stmt FILL IN FROM STEP 1 */ /* FILL IN ACTIONS FOR STEP 3 */
		  | while_stmt; /* FILL IN ACTIONS FOR STEP 3 */
...
FILL IN ACTIONS FOR STEP 3
*/

while_stmt returns [WhileNode node] : 'while' '(' cond ')' '{' statements '}'; /* FILL IN FOR STEP 3 */
...
cond returns [CondNode node] : e1=expr cmpop e2=expr; /* FILL IN FOR STEP 3 */
